...
const Home = () => {
    ...
    return (
        <div className='bg-primary flex flex-col items-center py-20'>
            ...
            <div className='border-t-[1.8px] w-[41rem] pt-10 border-black flex items-center justify-center w-full flex-col'>
            <h1 className='font-black text-3xl pb-6'>All Articles</h1>
            <div className='font-sans w-full grid grid-cols-2  gap-y-4'>
            {blogs?.map(blog => (
